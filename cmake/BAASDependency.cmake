...
function(_baas_find_requested_package dependency)
    ...
    elseif(dependency STREQUAL "sodium" OR dependency STREQUAL "libsodium")
        find_package(baas-libsodium CONFIG REQUIRED)
    elseif(dependency STREQUAL "libgit2")
        find_package(baas-libgit2 CONFIG QUIET)
        if(NOT TARGET BAAS::libgit2)
            message(FATAL_ERROR
                    "libgit2 requires conan install with -o \"&:use_libgit2=True\"")
        endif()
    elseif(dependency STREQUAL "lz4")
        find_package(baas-lz4 CONFIG REQUIRED)
    elseif(dependency STREQUAL "miniz")
        find_package(baas-miniz CONFIG REQUIRED)
