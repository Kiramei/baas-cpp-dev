...
Status: strict immutable definition parsing/model implemented; the bounded,
generation-bound support-bundle loader is also implemented. The engine adapter, externally published real
