...
- Registered positive cases: `happy/main`, `nested/valid`, `structured/main`
...
Host modules, async/tasks, the production bytecode VM, and production package
activation are intentionally outside version 1. Structured throw/catch/defer
is covered only for the bounded synchronous evaluator. Adding a case requires registering it in
